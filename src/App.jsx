...
export default function App() {
  ...
  return (
    <div className=" transition-all max-w-[1200px] m-auto ">
      <ToastContainer />
      <Header1></Header1>
      <div className="px-6  py-3 flex items-center gap-[200px]">
        <div className="flex items-center gap-4">
          ...
          <button className="btn rounded-lg flex items-center  p-2 gap-2  pr-5 pl-5 bg-purple-100 text-purple-700">
            <FiLayers /> Katalog
          </button>
        ...
        <div className="flex gap-10 items-center">
          ...
          <button onClick={() => setPage("cart")} className="btn btn-outline">
            <BiCart size={30} />
          </button>
          <button
        ...
        {page === "likes" && (
          <div className="p-4 max-w-4xl mx-auto">
            ...
            {likes.length > 0 ? (
              ...
              <p className="text-center text-gray-500">Layklar bo‘sh!</p>
            )}
          </div>
        )}
      </div>
